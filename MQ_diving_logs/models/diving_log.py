...
class DivingLog(models.Model):
    ...
    dive_number = models.IntegerField(verbose_name="Dive Number")
    dive_date = models.DateField(verbose_name="Dive Date")
    dive_site = models.CharField(max_length=255, verbose_name="Dive Site")
    dive_group = models.ForeignKey(DiveGroup, on_delete=models.SET_NULL, verbose_name="Dive Group")
    ...
    duration_dive = models.IntegerField(verbose_name="Dive Duration (min)")
    ...
    consumption_start = models.IntegerField(verbose_name="Consumption Start")
    consumption_end = models.IntegerField(verbose_name="Consumption End")

    # Conditions
    air_temperature = models.IntegerField(verbose_name="Air Temperature")
    water_temperature = models.IntegerField(verbose_name="Water Temperature")
    ...
    validated_by = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, related_name='validated_dives')
